...
def Capture():
    ...
    lbl8=Label(root,text ="Enroll the image",fg ='peachpuff' , font =("times new roman", 30),bg='steel blue')
...
def setTextInput2():
    global lbl18
    lbl18=Label(root,text ="Enter password",fg ='peach puff' , font =("times new roman", 30),bg='steel blue')
